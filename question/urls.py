...
from .views import DeleteAllQuestionsView,  ListQuestionsView, FilterQuestionsView, WordFileProcessorView

urlpatterns = [
    path('yuklash/', WordFileProcessorView.as_view(), name='upload_questions'),
